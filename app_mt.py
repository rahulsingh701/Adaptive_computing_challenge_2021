...
def app(image_dir,threads,model):
    ...
    if out_q > 0.5:
        print('The path is free, robot can move freely')
    else:
        print('The path is blocked, robot cannot move forward')
...
def main():
  ...
  ap.add_argument('-d', '--images',  type=str,default='blocked_path',            help='Path to folder of images.')
  ap.add_argument('-t', '--threads', type=int, default=1, help='Number of threads. Default is 1')
  ap.add_argument('-m', '--model',   type=str,default='collision_avoidance.xmodel',            help='Path of xmodel')
